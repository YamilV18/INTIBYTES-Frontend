...
export class UsersContainerComponent implements OnInit {
    ...
    public eventNew($event: boolean): void {
        if ($event) {
            ...
            userForm.componentInstance.title = 'Nuevo ChatMessage' || null;
    ...
    eventAssign($event: number) {
        ...
        // userForm.componentInstance.title = 'Asignar Service a Usuario' || null;
        // userForm.componentInstance.title = 'Asignar ChatMessage a Usuario' || null;
        // userForm.componentInstance.idUser = $event;
